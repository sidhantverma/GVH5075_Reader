  ...
  void onResult(BLEAdvertisedDevice advertisedDevice) {
    ...
    if (deviceName.startsWith("GVH5075")) {
      ...
      if (advertisedDevice.haveManufacturerData()) {
        ...
        if (manufacturerData.length() >= 8 && (unsigned char)manufacturerData[0] == 0x88 && (unsigned char)manufacturerData[1] == 0xEC) {
          ...
          //                          [ID  ] [? ] [encoded ] [bat][? ]
          uint32_t encoded = ((unsigned char)manufacturerData[3] << 16) | ((unsigned char)manufacturerData[4] << 8) | (unsigned char)manufacturerData[5];
          /*
          ...
          */
          ...
          // Validate ranges
          if (temperature >= -40.0 && temperature <= 60.0 && humidity >= 0.0 && humidity <= 100.0 && battery >= 0 && battery <= 100) {
